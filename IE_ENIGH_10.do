...
*BASE DE DATOS: ENIGH 2010


*Índice Educación**
*************

use "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/Pobla10.dta"
...
save "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/IE_ENIGH_10.dta", replace

*base de hijos
 

use "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/IE_ENIGH_10.dta", clear 

keep if id_madre =="1" | id_padre =="1" 

gen IDp= folioviv+foliohog+nr_padre

gen IDm= folioviv+foliohog+nr_madre
...
save "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_hijos_mf.dta", replace 
...
save "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_padre_mf.dta", replace 
 *base de madres
...
save "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_madre_mf.dta", replace 


use  "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_madre_mf.dta", clear 
...
*merges
 ...
 use "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_hijos_mf.dta", clear
 
merge m:1 folioviv foliohog IDp using "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_padre_mf.dta", gen(mergep)
...
*    *-----------------------------------------
 *   not matched                      103,618
 *      from master                    29,318(mergep==1)
  *      from using                     74,300  (mergep==2)

*    matched                            88,545(mergep==3)


merge m:1 folioviv foliohog IDm using "/Users/sergioparra/Desktop/Tesis/Bases de datos/MCS 2010/base_madre_mf.dta", gen(mergem)
*    -----------------------------------------
 ...
 *   -----------------------------------------
  *  not matched                       144,599
   *     from master                    78,795 (mergem==1)
    *    from using                     65,804 (mergem==2)

   * matched                          113,368(mergem==3)
    *-----------------------------------------
